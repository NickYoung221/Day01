...
import com.yang.interesting.spinmenufragment.Fragment1;
import com.yang.interesting.spinmenufragment.Fragment2;
import com.yang.interesting.spinmenufragment.Fragment3;
import com.yang.interesting.spinmenufragment.Fragment4;
import com.yang.interesting.spinmenufragment.Fragment5;
import com.yang.interesting.spinmenufragment.Fragment6;
import com.yang.interesting.spinmenufragment.Fragment7;
import com.yang.interesting.spinmenufragment.Fragment8;

import java.util.ArrayList;
import java.util.List;

public class SpinMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spin_menu);
        ...
        spinMenu.setOnSpinMenuStateChangeListener(new OnSpinMenuStateChangeListener() {
            ...
            public void onMenuOpened() {
                Toast.makeText(SpinMenuActivity.this, "SpinMenu opened", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onMenuClosed() {
                Toast.makeText(SpinMenuActivity.this, "SpinMenu closed", Toast.LENGTH_SHORT).show();
            }
        });
